class FactsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @fact.update(fact_params)
        format.html { redirect_to @fact, notice: "Fact was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to facts_path, notice: "Fact was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_fact
      @fact = Fact.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def fact_params
      params.expect(fact: [ :name, :description ])
    end
end
